...
// 
    ...
    public partial class Comprobante
    {
        ...
        [XmlIgnore]
        public AddendaAHM AddendaAHM { get; set; }

        [XmlIgnore]
        public DSCargaRemisionProv AddendaSoriana { get; set; }

        [XmlIgnore]
        public Addenda AddendaAdo { get; set; }
        ...
        [XmlIgnore]
        public List<ConceptoInformativo> ListaConceptoInformativo { get; set; }
        ...
        [XmlIgnore]
        public ImpuestosLocales implocal { get; set; }
        [XmlIgnore]
        public LeyendasFiscales leyendasFicales { get; set; }
